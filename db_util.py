"""
Populate the database tables with pre-defined data.
"""
from __future__ import print_function
from os import getenv
from sqlalchemy import create_engine
from sqlalchemy.orm import sessionmaker
from db_models import Restaurant, BASE, MenuItem, User
...
def populate_db(db_uri):
    ...
    menu_item1 = MenuItem(user_id=1, name="French Fries",
    ...
    menu_item3 = MenuItem(user_id=1, name="Chocolate Cake",
    ...
    menu_item4 = MenuItem(user_id=1, name="Sirloin Burger",
    ...
    menu_item5 = MenuItem(user_id=1, name="Root Beer",
    ...
    menu_item2 = MenuItem(user_id=1, name="Peking Duck",
                          description=" A famous duck dish from Beijing that "
                                      "has been prepared "
                                      "since the imperial era. The meat is "
                                      "prized for its thin, crisp skin, "
    ...
    menu_item5 = MenuItem(user_id=1, name="Beef Noodle Soup",
                          description="A Chinese noodle soup made of stewed "
                                      "or red "
                                      "braised beef, beef broth, vegetables "
                                      "and Chinese noodles.",
    ...
    menu_item1 = MenuItem(user_id=1, name="Pho",
                          description="a Vietnamese noodle soup consisting of "
                                      "broth, "
                                      "linguine-shaped rice noodles called "
    ...
    menu_item2 = MenuItem(user_id=1, name="Chinese Dumplings",
                          description="a common Chinese dumpling which "
                                      ...
                                      "piece of dough skin. The skin can be "
    ...
    menu_item2 = MenuItem(user_id=1, name="Mushroom risotto",
                          description="Portabello mushrooms in a creamy "
                                      "risotto",
                          price="$5.99", course="Entree",
                          restaurant=restaurant1)
    ...
    menu_item5 = MenuItem(user_id=1, name="Aloo Gobi Burrito",
                          description="Vegan goodness. Burrito filled with "
                                      ...
                                      "(aloo), "
                                      "fried cauliflower (gobi) and chutney. "
                                      "Nom Nom",
    ...
    menu_item2 = MenuItem(user_id=1, name="Chicken and Rice",
    ...
    menu_item4 = MenuItem(user_id=1,
                          name="Choc Full O\' Mint (Smitten\'s Fresh Mint "
                               "Chip ice cream)",
    ...
    menu_item1 = MenuItem(user_id=1, name="Lamb Curry",
    ...
    menu_item2 = MenuItem(user_id=1, name="Chicken Marsala",
    ...
    menu_item3 = MenuItem(user_id=1, name="Potstickers",
    ...
    menu_item4 = MenuItem(user_id=1, name="Nigiri Sampler",
                          description="Maguro, Sake, Hamachi, Unagi, Uni, "
                                      "TORO!",
    ...
    menu_item1 = MenuItem(user_id=1, name="Boysenberry Sorbet",
                          description="An unsettlingly huge amount of ripe "
                                      "berries turned "
                                      "into frozen (and seedless) awesomeness",
                          price="$2.99", course="Dessert",
                          restaurant=restaurant1)
    ...
    menu_item2 = MenuItem(user_id=1, name="Broiled salmon",
    ...
    menu_item4 = MenuItem(user_id=1, name="Tandoori Chicken",
                          description="Chicken marinated in yoghurt and "
                                      "seasoned with a spicy mix(chilli, "
                                      "tamarind among others) and slow cooked "
                                      "in a cylindrical clay or "
                                      "metal oven which gets its heat from "
                                      "burning charcoal.",
    ...
    menu_item10 = MenuItem(user_id=1, name="Spinach Ice Cream",
    ...
    menu_item2 = MenuItem(user_id=1, name="Cachapa",
                          description="Golden brown, corn-based Venezuelan "
                                      "pancake; usually stuffed "
                                      "with queso telita or queso de mano, "
                                      "and possibly lechon. ",
                          price="$7.99", course="Entree",
                          restaurant=restaurant1)
    ...
    menu_item1 = MenuItem(user_id=1, name="Chantrelle Toast",
...
if __name__ == '__main__':
    if getenv("DATABASE_URL"):
        populate_db(getenv("DATABASE_URL"))
    else:
        populate_db("sqlite:///restaurant_menu_with_users.db")
