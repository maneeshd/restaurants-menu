...
def populate_db(db_uri):
    ...
    menu_item2 = MenuItem(user_id=1, name="Peking Duck",
                          description=" A famous duck dish from Beijing that has been prepared "
    ...
    menu_item2 = MenuItem(user_id=1, name="Chinese Dumplings",
                          description="a common Chinese dumpling which generally consists of "
                                      ...
                                      "piece of dough skin. The skin can be either thin and elastic or thicker.",
    ...
    menu_item2 = MenuItem(user_id=1, name="Mushroom risotto", description="Portabello mushrooms in a creamy risotto",
                          price="$5.99", course="Entree", restaurant=restaurant1)
    ...
    menu_item1 = MenuItem(user_id=1, name="Boysenberry Sorbet",
                          description="An unsettlingly huge amount of ripe berries turned "
    ...
    menu_item4 = MenuItem(user_id=1, name="Tandoori Chicken",
                          description="Chicken marinated in yoghurt and seasoned with a spicy mix(chilli, "
                                      "tamarind among others) and slow cooked in a cylindrical clay or "
